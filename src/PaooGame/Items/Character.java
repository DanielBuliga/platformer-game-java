...
public abstract class Character extends Item
{
    ...
    public static final int DEFAULT_CREATURE_WIDTH  = (int) (80 * SCALE); //120   /*!< Latimea implicita a imaginii caracterului.*/
    public static final int DEFAULT_CREATURE_HEIGHT = (int)( 64 * SCALE);  //96 /*!< Inaltimea implicita a imaginii caracterului.*/

    public static final int DEFAULT_ENEMY_WIDTH  = 168;   /*!< Latimea implicita a imaginii inamicului.*/
    public static final int DEFAULT_ENEMY_HEIGHT = 96;   /*!< Inaltimea implicita a imaginii inamicului.*/
